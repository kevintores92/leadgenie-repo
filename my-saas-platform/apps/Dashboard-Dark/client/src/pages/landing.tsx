...
// Import available assets from this app's attached_assets folder
import heroBg from "@assets/generated_images/abstract_dark_blue_tech_background.png";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <motion.div variants={fadeInUp} className="mb-6">
                <Badge
                  variant="outline"
                  className="px-4 py-1.5 rounded-full border-primary/50 text-primary bg-primary/10 backdrop-blur-sm text-sm font-medium"
                >
              ...
              <motion.h1
                variants={fadeInUp}
                className="text-5xl md:text-7xl font-bold font-heading leading-tight mb-3"
              >
              ...
              <motion.p
                variants={fadeInUp}
                className="text-3xl md:text-4xl font-bold font-heading mb-8 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-purple-400"
              >
              ...
              >
                Stop chasing leads. Our fully automated AI platform that calls and texts
                prospects, qualifying them 24/7 while you sleep.
              </motion.p>
              ...
              <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4">
                <a href="#free-trial">
                  <Button
                    size="lg"
                    className="h-14 px-8 text-lg rounded-full bg-gradient-to-r from-purple-500/10 to-pink-500/10 hover:from-purple-500/20 hover:to-pink-500/20 border-2 border-transparent bg-clip-padding shadow-lg shadow-purple-500/10 relative overflow-hidden group backdrop-blur-sm"
                    style={{
                      backgroundImage:
                        "linear-gradient(rgb(15, 23, 42), rgb(15, 23, 42)), linear-gradient(90deg, rgb(168, 85, 247), rgb(236, 72, 153))",
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-8">
            ...
            <p className="text-slate-400 text-sm">
              Set it and forget it. Our autonomous system handles the entire lead generation
              lifecycle from cold outreach to qualification.
            </p>
          </div>
      ...
      <section id="features" className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-purple-500/10 text-purple-400 hover:bg-purple-500/20 border-purple-500/20">
              AI Superchargers
            </Badge>
            <h2 className="text-4xl md:text-5xl font-bold font-heading mb-6">
              While You Wait... <br />The AI Gets to Work
            </h2>
            <p className="text-slate-400 max-w-2xl mx-auto">
              Don&apos;t lose time waiting for 10DLC approval. Our parallel processing AI
              engine starts working immediately.
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <h2 className="text-5xl md:text-6xl font-bold font-heading mb-6">
                Try Lead Genie Risk-Free
              </h2>
              <p className="text-xl text-slate-400 max-w-2xl mx-auto">
                Experience the power of autonomous lead generation with real AI interactions.
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-16">
              ...
              >
                ...
                <p className="text-slate-400 mb-4">
                  Add 10-20 of your own numbers from your skiptraced list.
                </p>
              ...
              >
                ...
                <p className="text-slate-400 mb-4">
                  Not convinced? No problem. Cancel anytime, no questions asked, no hidden fees.
                </p>
            ...
            >
              <Link href="/auth">
                <Button
                  size="lg"
                  className="h-16 px-12 text-xl rounded-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 shadow-2xl shadow-green-500/30 border border-white/10"
                >
                  Start Your Free Trial
              ...
              <p className="mt-8 text-sm text-slate-400 font-medium">
                <span className="text-green-400 font-semibold">No credit card required</span> • Instant access • See real
                results
              </p>
            </motion.div>
          </div>
      ...
      <footer className="py-12 border-t border-white/5 bg-black/20">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="text-slate-500 text-sm">© 2024 Lead Genie. All rights reserved.</div>
          </div>
        </div>
      </footer>
    </div>
    ...
    >
      <Card className="h-full bg-white/5 border-white/10 hover:bg-white/10 transition-colors duration-300">
        <CardContent className="p-6">
          <div className="mb-4 p-3 rounded-xl bg-background/50 w-fit border border-white/5">{icon}</div>
